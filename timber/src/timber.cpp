...
int main() {
	...
	spriteTree3.setPosition(300, 0);
	spriteTree4.setPosition(1300, 0);
	spriteTree5.setPosition(1600, 0);
	spriteTree6.setPosition(1800, 0);
	...
	// Some other useful log related varibales
	...
	while (window.isOpen()){
		...
		if (!beeActive){
			...
			// достигла ли пчела правого края экрана?
